...
export default function LeadForm() {
  ...
  return (
    <div className="relative flex min-h-[100dvh] w-full flex-col bg-[#0c2d48] font-inter overflow-x-hidden">
      {/* Progress Dots - Sticky at top */}
      {showProgress && (
        <div className="flex gap-1.5 justify-center py-4 px-6 shrink-0 z-10 bg-[#0c2d48]">
          {flow.screens
